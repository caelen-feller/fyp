...
Code and literature for my (Caelen Feller) 4th year project in Mathematics with Trinity College Dublin. 
...
## Current Goals:
 ...
 - Extend implementation and theory to handle: 
   ...
   - Elongated domains
   - Slits in domains
 - Feasibility study of applying method to higher dimensional cases.
 - Apply method to simple higher dimensional cases (if possible)
